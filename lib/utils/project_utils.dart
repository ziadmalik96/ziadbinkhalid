class ProjectUtils {
  static const List<String> banners = [
    ...
    "assets/projects/nippondealer.png",
    "assets/projects/arabsea.png",
    "assets/projects/asmr.png",
  ];
  ...
  static const List<String> description = [
    ...
    "Nippon Dost dealer application is an application developed for Nippon Paint Dealers to help redeem gifts and rewards earned by Painters who use the Nippon Paint Dost application.",
    "Online Store is an eCommerce Store that allows customers to shop their favorite products online.",
  ...
  static const List<String?> links = [
    ...
    "https://play.google.com/store/apps/details?id=com.nippon.dealer.nippon",
    "https://play.google.com/store/apps/details?id=com.threescart.arabsea",
    "https://play.google.com/store/apps/details?id=com.eugibo.asmrtriggers&hl=en&gl=US",
  ];
}
